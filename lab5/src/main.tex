...
\usepackage[per-mode=symbol,alsoload=binary]{siunitx} % for nice units and junk!
...
\newcommand{\docTitle}{Analog-to-Digital Conversion}
\newcommand{\courseName}{ECE-L303}
\newcommand{\labNum}{Lab 5}
\newcommand{\labSec}{062}
\newcommand{\dueDate}{28 October 2011}
\newcommand{\perfDate}{21 October 2011}
...
%\listoftables    % there's way fewer of them
